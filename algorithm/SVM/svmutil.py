...
from algorithm.SVM.svm import *
from algorithm.SVM.svm import __all__ as svm_all
from algorithm.SVM.svm import scipy, sparse
from algorithm.SVM.commonutil import *
from algorithm.SVM.commonutil import __all__ as common_all
    ...
    if predict_probability:
        ...
        for i in range(nr_instance):
            if scipy and isinstance(x, sparse.spmatrix):
                ...
                xi, idx = gen_svm_nodearray((x.indices[indslice], x.data[indslice]),
